  ...
  return (
    <section className="container-fluid px-md-5 py-5 my-5" id="about">
      <div className="row align-items-center">
        ...
        >
          ...
          <div className="text-secondary-custom fs-5">
            <p className="mb-4">
              ...
              <span className="text-white fw-bold">engineering precision</span>{" "}
              and{" "}
              <span className="text-white fw-bold">
                modern web architecture
              </span>
              . My journey isn't just about syntax; it's about solving complex
              problems.
            </p>
            ...
            <p className="mb-4">
              ...
              . This daily discipline in <span className="text-white">C++</span>{" "}
              ensures my algorithmic thinking stays sharp while I build
              user-centric applications like
              <span className="text-white fw-bold"> MedLink.AI</span>.
            </p>

            <p>
              When I'm not debugging a Flask backend or refining a React
              frontend, I’m usually experimenting with{" "}
              <span className="text-info">minimalist digital aesthetics</span>
        ...
        >
          <div
            className="p-4 custom-card border-warning shadow-lg"
            ...
            <ul className="list-unstyled text-secondary-custom">
              <li className="mb-3 d-flex align-items-start">
                ...
                <div>
                  ...
                  <br />
                  <small>React, Python Flask, MySQL</small>
                </div>
              </li>
              <li className="mb-3 d-flex align-items-start">
                <span className="text-warning me-2">✦</span>
                <div>
                  ...
                  <br />
                  <small>C++ Data Structures & Algorithms</small>
                </div>
              </li>
              <li className="mb-3 d-flex align-items-start">
                <span className="text-warning me-2">✦</span>
                <div>
                  ...
                  <br />
                  <small>Gemini API & LLM Workflows</small>
                </div>
              </li>
            </ul>
