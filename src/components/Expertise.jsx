...
const Expertise = () => {
  ...
  const tags = ["JavaScript", "Python", "MySQL", "React", "Bootstrap", "Git", "C++", "REST APIs"];

  return (
    <section className="container-fluid px-md-5 py-5 my-5" id="expertise">
      <div className="text-center mb-5">
        <h6 className="text-warning text-uppercase fw-bold mb-2" style={{ letterSpacing: '2px' }}>Expertise</h6>
        <h2 className="display-4 fw-bold text-white">Skills & <span className="text-warning">Technologies</span></h2>
      </div>
        ...
        <div className="col-lg-10">
          ...
          {skills.map((skill, index) => (
            <div key={index} className="mb-4">
              ...
              <div className="progress bg-dark" style={{ height: '4px', borderRadius: '10px' }}>
                <motion.div 
